...
Настройки.Вставить("НастройкиПлагинов", НастройкиПлагинов());
...
Для Каждого Инф Из Настройки.ФайлыДляОформления Цикл
	...
	Попытка
		...
		ПараметрыПлагинов[ПлагинОформительОтступов] = Настройки.НастройкиПлагинов.ПараметрыОформителяОтступов;
		...
		Если Настройки.НастройкиПлагинов.ПараметрыВыравниванияАргументов.Использовать Тогда
			...
			ПараметрыПлагинов = Новый Соответствие();
			ПараметрыПлагинов[ПлагинВыравниваниеАргументов] = Настройки.НастройкиПлагинов.ПараметрыВыравниванияАргументов;
