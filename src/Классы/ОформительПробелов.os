...
Функция Закрыть() Экспорт
	...
	ОперацииПослеКоторыхВсегдаЕстьПробел.Вставить("Если");
	...
	ТокеныОпределяющиеВычитание = Новый Структура();
	ТокеныОпределяющиеВычитание.Вставить("Идентификатор");
	ТокеныОпределяющиеВычитание.Вставить("Число");
	ТокеныОпределяющиеВычитание.Вставить("ДатаВремя");
	ТокеныОпределяющиеВычитание.Вставить("ПраваяКруглаяСкобка");
	ТокеныОпределяющиеВычитание.Вставить("ПраваяКвадратнаяСкобка");
	...
	Для Индекс = 1 По КоличествоТокенов - 2 Цикл
		...
		ИначеЕсли Индекс > 1 И Начало.Токен = "ЗнакВычитания"
			...
			Если Не ТокеныОпределяющиеВычитание.Свойство(ТаблицаТокенов[Индекс - 1].Токен) Тогда
				СтрокаДляЗамены = "";
			КонецЕсли;
