...
Функция Закрыть() Экспорт
	...
	Для Индекс = 1 По КоличествоТокенов-2 Цикл   
		...
		Если СтрокаДляЗамены <> Сред(Исходник, Начало.Позиция+Начало.Длина, Конец.Позиция - Начало.Позиция - Начало.Длина) Тогда
			...
			НоваяЗамена.Длина = Конец.Позиция - Начало.Позиция - Начало.Длина;
